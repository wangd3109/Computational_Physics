program main
      implicit none
      real(8) :: lattice(50,50),jex,b,randomx,randomy,h1,h2,tmp,t,summationh,summationm,averageh,averagem,mag,start,finish,m2,m4,u
...
subroutine hamil(grid,jex,b,lattice,mag,h)
        implicit none
        real(8) :: lattice(50,50),h,jex,b,summation1,mag        !这里x没有问题？
