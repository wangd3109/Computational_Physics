program main
      implicit none
      real(8) :: lattice(16,16),jex1,jex2,b,randomx,randomy,h1,h2,tmp,t,summationh,summationm,averageh,averagem,mag,start,finish
...
subroutine hamil(grid,jex1,jex2,b,lattice,mag,h)
        implicit none
        real(8) :: lattice(16,16),h,jex1,jex2,b,summation1,summation2,mag        !这里x没有问题？
